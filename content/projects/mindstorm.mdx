...
<img src="/mindstorm/mindstorm-characters.png" alt="mindstorm poster" style={{ borderRadius: '1rem', margin: '2rem 0' }} />
...
<img src="/mindstorm/mindstorm-chat.png" alt="mindstorm insights page" style={{ borderRadius: '1rem', margin: '2rem 0' }} width="35%"/>

</div>
### Weekly Insights:

<img src="/mindstorm/mindstorm-insights.png" alt="mindstorm insights page" style={{ borderRadius: '1rem', margin: '2rem 0' }} width="60%" />
